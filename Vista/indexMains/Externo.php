        ...
        <li class="navbar__list__item">
          ...
          <ul class="navbar__submenu">
            <li class="navbar__submenu__item">
              <a href="../referencias/Externo/PaquetesLotes.php">Paquete a Lote</a>
            </li>
            <li class="navbar__submenu__item">
              <a href="../referencias/Externo/LotesCamiones.php">Lote a Camión</a>
            </li>
            <li class="navbar__submenu__item">
              <a href="../referencias/Externo/CamionesCamioneros.php">Camionero a Camión</a>
            </li>
          </ul>
        </li>
      </ul>
