    ...
    <body>
        ...
        <div class="form__container__backoffice">
            ...
            <div class="form">
                ...
                <form action="CRUD/usuarios/Altas.php" method="post">
                    ...
                    Tipo <input class="form__input" type="text" name="user[]" placeholder="'Almacen' , 'Externo' o 'Camionero'"><br><br>
            ...
            <div class="form">
                ...
                <iframe src="CRUD/almacenes/mostrarLista.php" style="height: 400px;  border-radius: 5px ;border: #ffc870 3px solid;">
                </iframe>
            </div>
            <div class="form">
        ...
        <div class="form__container__backoffice">
            <div class="form">
                ...
                <iframe src="CRUD/paquetes/mostrarLista.php" style="height: 400px;  border-radius: 5px ;border: #ffc870 3px solid;">>
                </iframe>
            </div>
            <div class="form">
        ...
        <div class="form__container__backoffice">
            <div class="form">
                ...
                <iframe src="CRUD/lotes/mostrarLista.php" style="height: 400px;  border-radius: 5px ;border: #ffc870 3px solid;">>
                </iframe>
            </div>
            <div class="form">
                <h2>Ingresar lote</h2>
